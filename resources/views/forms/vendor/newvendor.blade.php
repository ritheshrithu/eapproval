                   ...
                   <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="new2" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('vendorcode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="vendorcode" type="text" class="form-control" name="vendorcode" value="{{ old('vendorcode') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('paymentterms') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="paymentterms" type="text" class="form-control" name="paymentterms" value="{{ old('paymentterms') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('address1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor4" type="text" class="form-control"  name="address1" value="{{ old('address1') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group{{ $errors->has('address2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor5" type="text" class="form-control"  name="address2" value="{{ old('address2') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group{{ $errors->has('address3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor6" type="text" class="form-control" name="address3" value="{{ old('address3') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fax" type="number" class="form-control" name="fax" value="{{ old('fax') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('proposed') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor" type="text" class="form-control" name="proposed" value="{{ old('proposed') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('justification') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor1" type="text" class="form-control" name="justification" value="{{ old('justification') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('paymentofterm') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor2" type="text" class="form-control" name="paymentofterm" value="{{ old('paymentofterm') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('referenceif') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor3" type="text" class="form-control" name="referenceif" value="{{ old('referenceif') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('esi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="esi" type="text" class="form-control" name="esi" value="{{ old('esi') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('vendor') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="vendortype" type="text" class="form-control" name="vendortype" value="{{ old('vendortype') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('gststate') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="gststate" type="text" class="form-control" name="gststate" value="{{ old('gststate') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('gstin') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="gstin" type="text" class="form-control" name="gstin" value="{{ old('gstin') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="hsncode" value="{{ old('email') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="saccode" value="{{ old('email') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
