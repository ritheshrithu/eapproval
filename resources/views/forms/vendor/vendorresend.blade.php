            ...
            <div class="panel panel-default">
                ...
                <div class="container">
                   ...
                   <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="resend2" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('des') ? ' has-error' : '' }}">
                            <label for="des" class="col-md-4 control-label">DESCRIPTION / MESSAGE </label>

                            <div class="col-md-6">
                                <textarea id="ckeditor2" type="text" class="form-control" name="des" value="{{ old('des') }}" required autofocus></textarea>
                            </div>
                        </div>
                        <hr>
