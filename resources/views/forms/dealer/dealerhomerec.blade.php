...
<div class="container">
    <div class="row">    
        <div class="col-md-12">
            ...
            <a href="{{ url('/') }}/approvals/dealerapproval">DEALER APPROVAL    </a><span class="fa fa-arrow-right"></span></H4>
            </center>
        </div>
    </div>
</div><br>
                   ...
                   <div class="panel-body">   
                        <div class="table-responsive">
                               ...
                               <tbody>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><center>@sortablelink('name','NAME')</center></th>
                             ...
                             @if(Auth::user()->roll === $approval->rec && $approval->update1 !== null || 
                                ...
                                Auth::user()->roll === $approval->rec3 && $approval->update4 !== null)
                                    ...
                                    <tr>
                                        ...
                                        <td><center>{{ $approval->name }}</center></td>
                            ...
                            @endif
                                        ...
                                        <td><center>
                                            <a href="{{ url('/') }}/approvals/dealerapproval/{{$approval->id}}" class="btn btn-info">VIEW</a></center>
                                        </td>
                                    </tr>
