            ...
            <div class="panel panel-default">
                ...
                <div class="container">
                   ...
                   <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="newd" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $dealer->name}}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor" type="text" class="form-control" name="address" value="" required autofocus>{{ $dealer->address}}</textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ $dealer->email}}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('pan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pan" type="pan" class="form-control" name="pan" value="{{ $dealer->pan}}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('constitution') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select name="constitution" id="constitution" class="form-control" required autofocus>
                                    <option>{{ $dealer->constitution}}</option>
                        ...
                        <div class="form-group{{ $errors->has('handler') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="handler" type="text" class="form-control" name="handler" value="{{ $dealer->handler}}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('year') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="year" type="number" class="form-control" name="year" value="{{ $dealer->year}}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('gst') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="gst" type="text" class="form-control" name="gst" value="{{ $dealer->gst}}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('state') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="state" type="text" class="form-control" name="state" value="{{ $dealer->state}}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('dealerbank') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor1" type="text" class="form-control" name="dealerbank" value="" required autofocus>{{ $dealer->dealerbank}}</textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('authdealer') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor2" type="text" class="form-control" name="authdealer" value="" required autofocus>{{ $dealer->authdealer}}</textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('authdirect') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor3" type="text" class="form-control" name="authdirect" value="" required autofocus>{{ $dealer->authdirect}}</textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('cutting') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor4" type="text" class="form-control" name="cutting" value="" required autofocus>{{$dealer->cutting}}</textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('reason') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor5" type="text" class="form-control" name="reason" value="" required autofocus>{{ $dealer->reason}}</textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <label for="nettake1" class="col-md-4 control-label">I</label>
                                    <div class="col-md-6">
                                        <input id="nettake1" type="text" class="form-control" name="nettake1" value="{{ $dealer->nettake1}}" required autofocus>
                                    </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <label for="snettake" class="col-md-4 control-label">II</label>
                                    <div class="col-md-6">
                                        <input id="nettake2" type="text" class="form-control" name="nettake2" value="{{ $dealer->nettake2}}" required autofocus>
                                    </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <label for="nettake3" class="col-md-4 control-label">III</label>
                                    <div class="col-md-6">
                                        <input id="sales3" type="text" class="form-control" name="nettake3" value="{{ $dealer->nettake3}}" required autofocus>
                                    </div>
                        </div>
                        <br>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('paymentterms') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor6" type="text" class="form-control" name="paymentterms" value="" required autofocus>{{ $dealer->paymentterms}}</textarea>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="form-group{{ $errors->has('receiver') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" id="rec" name="rec" required> 
                                <option>{{$dealer->rec}}</option>
                                <option>MANAGER - {{ Auth::user()->manager }} - {{ $off1 }}</option>
                                <option>SUPERUSER - {{ Auth::user()->superuser }} - {{ $off2 }}</option>
                                <option>SUPERVISOR - {{ Auth::user()->supervisor }} - {{ $off3 }}</option>
                                <option>PLANTHEAD - {{ Auth::user()->planthead }} - {{ $off4 }}</option>
                                <option>VPO - {{ Auth::user()->vpo }} - {{ $off5 }}</option>
                                <option>VPCA - {{ Auth::user()->vpca }} - {{ $off6 }}</option>
