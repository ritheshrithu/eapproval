...
<div class="container">
     <div class="row">
        <div class="col-md-3">
            <a href="{{ url('/') }}/approvals/dealerapproval/{{ $dealer->id}}" class="btn btn-info">BACK</a>
        </div>     
        <div class="col-md-8">
            ...
            <a href="{{ url('/') }}/createapproval/dealerapproval/new">NEW DEALER APPROVAL    </a></H4>
        </div>
    </div>
    </div><br>
            ...
            <div class="panel panel-default">
                ...
                <div class="container">
                   ...
                   <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="forward4" enctype="multipart/form-data">
                        {{ csrf_field() }}
