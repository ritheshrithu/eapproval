...
<div class="container-fluid">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <a href="{{url('/')}}/oldapprovals/dealerapproval/" class="btn btn-info">GO BACK</a>
                        <a href="{{url('/')}}/oldapprovals/dealerapproval/{{$dealer->id}}/pdf" class="btn btn-warning" target="_blank">VIEW PDF</a>
                    </div>     
        <div class="col-md-8">
            <H4><a href="{{ url('/') }}/oldapprovals/">RECEIVED APPROVALS    </a><span class="fa fa-arrow-right"></span>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                               <tr class="clearfix">
                                ...
                                <tr class="clearfix">
                                    <td colspan="1"><center>{{$dealer->rec}}</center></td>
                                    <td colspan="1"><center>{{$dealer->rec1}}</center></td>
                                    <td colspan="1"><center>{{$dealer->rec2}}</center></td>
                                    <td colspan="1"><center>{{$dealer->rec3}}</center></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
