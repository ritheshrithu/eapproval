...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <a href="{{ url('/') }}/createapproval/capexapproval/new" class="btn btn-success">CREATE NEW</a>
        </div>     
        <div class="col-md-8">
            <H4><a href="{{ url('/') }}/oldapprovals/">GENERATED APPROVALS    </a><span class="fa fa-arrow-right"></span>
            <a href="{{ url('/') }}/oldapprovals/capexapproval">CAPEX APPROVAL    </a><span class="fa fa-arrow-right"></span></H4>
        </div>
    </div>
</div><br>
@include('senside')
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($capex as $approval)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/') }}/oldapprovals/capexapproval/{{$approval->id}}" class="btn btn-info">VIEW</a>
                                            {!! Form::open([
                            'method'=>'DELETE',
                            'url' => ['/oldcapex', $approval->id],
