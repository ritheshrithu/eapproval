            ...
            <div class="panel panel-default">
               <div class="panel-heading"><center><h3>APPROVE {{ $capex->title }}</h3></center></div>
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="resend" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('des') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor" type="text" rows="5" cols="1" class="form-control" name="des" value=" " required></textarea> 
                            </div>
                        </div>
                        <hr>
