            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <a href="{{url('/')}}/approvals/capexapproval/{{$capex->id}}/pdf" class="btn btn-warning" target="_blank">VIEW PDF</a>
                    </div>     
        <div class="col-md-8">
            <H4><a href="{{ url('/') }}/approvals/">RECEIVED APPROVALS    </a><span class="fa fa-arrow-right"></span>
            <a href="{{ url('/') }}/approvals/capexapproval">CAPEX APPROVAL    </a><span class="fa fa-arrow-right"></span>
            <a href="{{ url('/') }}/approvals/capexapproval/{{$capex->id}}"> {{$capex->title}}    </a></H4>
        </div>
    </div>
            </div><br><br>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered">
                          ...
                          <tbody>
                                ...
                                <tr class="clearfix">
                                    ...
                                    <td colspan="1" class="text-justify"><b>SPECIAL INSTRUCTION TO SALES 
                                       <a class="fa fa-info-circle lead" title="HOW THE NEW EQUIPMENT ADDED IS GOING TO AFFECT THE PRESENT PATTERN OF PRODUCTION SUCH AS BATCH QUANTITY, TYPE OF TOOLS, ETC" data-toggle="tooltip">
                    ...
                    <div class="col-md-6">
                        <center>
                        <a href="{{url('/')}}/approvals/capexapproval/{{$capex->id}}/resend" class="btn btn-danger">RESEND</a>
                        </center>
                    </div>
                    <div class="col-md-6">
                        <center>  
                            <a href="{{url('/')}}/approvals/capexapproval/{{$capex->id}}/forward/" class="btn btn-success">FORWARD</a>    
                        </center>
                    </div>
                </div><br><br><br>
