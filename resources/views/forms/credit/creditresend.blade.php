           ...
           <div class="panel panel-default">
                ...
                <div class="container">
                   ...
                   <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="resend1" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('des') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor" type="text" class="form-control" name="des" required  autofocus></textarea>
                            </div>
                        </div>
                        <hr>
