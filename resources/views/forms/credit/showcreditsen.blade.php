...
<div class="container-fluid">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <a href="{{url('/')}}/oldapprovals/creditapproval/" class="btn btn-info">GO BACK</a>
                        <a href="{{url('/')}}/oldapprovals/creditapproval/{{$credit->id}}/pdf" class="btn btn-warning" target="_blank">VIEW PDF</a>
                    </div>     
        <div class="col-md-8">    
