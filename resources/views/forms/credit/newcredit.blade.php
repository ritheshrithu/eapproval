            ...
            <div class="panel panel-default">
                ...
                <div class="container">
                   ...
                   <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="new1" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('constitution') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                        <select for="constitution" class="form-control" id="constitution" name="constitution">
                        ...
                        <div class="row">
                            <div class="form-group{{ $errors->has('doc1') ? ' has-error' : '' }}">
                                <div class="col-md-4">
                                    <input id="doc1" type="file" class="form-control" name="doc1" value="{{ old('doc1') }}" autofocus>
                                </div>
                            
                                <div class="col-md-4">
                                    <input id="doc2" type="file" class="form-control" name="doc2" value="{{ old('doc2') }}" autofocus>
                                </div>
                           
                                <div class="col-md-4">
                                    <input id="doc3" type="file" class="form-control" name="doc3" value="{{ old('doc3') }}" autofocus>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('pan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pan" type="text" class="form-control" name="pan" value="{{ old('pan') }}" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="form-group{{ $errors->has('currency') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="currency" type="number" class="form-control" name="currency" value="INR" required autofocus>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input id="bankbranch" type="text" class="form-control" name="bankbranch" value="{{ old('bankbranch') }}" required autofocus>
                            </div>
                        </div>
                        <br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input id="bankaccno" type="number" class="form-control" name="bankaccno" value="{{ old('bankaccno') }}" required autofocus>
                            </div>
                        </div>
                        <br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input id="bankifsc" class="form-control" name="bankifsc" value="{{ old('bankifsc') }}" required autofocus>
                            </div>
                        </div>
                        <br><br>
                        ...
                        <div class="form-group{{ $errors->has('setup') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor1" type="text" class="form-control" name="setup" value="{{ old('setup') }}" required autofocus></textarea>
                            </div>
                        ...
                        <div class="row">
                            <label for="component" class="col-md-4 control-label">COMPONENT MANUFACTURING</label>
                                    <div class="col-md-6">
                                        <input id="component" type="text" class="form-control" name="component" value="{{ old('component') }}" required autofocus>
                                    </div>      
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <label for="supplied" class="col-md-4 control-label">SUPPLIED TO</label>
                                    <div class="col-md-6">
                                        <input id="supplied" type="text" class="form-control" name="supplied" value="{{ old('supplied') }}" required autofocus>
                                    </div>  
                        </div>
                        <hr>
                        <div class="form-group{{ $errors->has('cuttools') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                        <select class="form-control" id="cuttools" onchange="dealing(this);" name="cuttools">
                                            <option>Select...</option> 
                        ...
                        <br><br>
                        <div id="dealingdiv" style="display:none;">
                            <br><br>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input id="source" type="text" class="form-control" name="source" value="{{ old('source') }}" autofocus>
                            </div>
                        </div>
                        <br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <textarea id="ckeditor2" type="number" class="form-control" name="brands" value="{{ old('brands') }}" autofocus></textarea>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <label for="sales1" class="col-md-4 control-label">{{\Carbon\Carbon::now()->format('Y')}}</label>
                                    <div class="col-md-6">
                                        <input id="sales1" type="text" class="form-control" name="sales1" value="{{ old('sales1') }}" required autofocus>
                                    </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <label for="sales2" class="col-md-4 control-label">{{\Carbon\Carbon::now()->format('Y') - 1}}</label>
                                    <div class="col-md-6">
                                        <input id="sales2" type="text" class="form-control" name="sales2" value="{{ old('sales2') }}" required autofocus>
                                    </div>
                        </div>
                        <br><br>
                        <div class="row">
                            <label for="sales3" class="col-md-4 control-label">{{\Carbon\Carbon::now()->format('Y') - 2}}</label>
                                    <div class="col-md-6">
                                        <input id="sales3" type="text" class="form-control" name="sales3" value="{{ old('sales3') }}" required autofocus>
                                    </div>
                        </div>
                        <br>
                        <hr>
                        <div class="row">
                            <label for="employees" class="col-md-4 control-label">NO OF EMPLOYEES</label>
                                    <div class="col-md-6">
                                        <input id="employees" type="text" class="form-control" name="employees" value="{{ old('employees') }}" required autofocus>
                                    </div>
                        </div>
                        <hr>
                        <div class="row">
                            <label for="transaction" class="col-md-4 control-label">NATURE OF TRANSACTION, IF ANY, WITH ANY OF THE AMALGAMATIONS GROUP WITH TERMS OF PAYMENT</label>
                                    <div class="col-md-6">
                                        <textarea id="ckeditor3" type="text" class="form-control" name="transaction" value="{{ old('transaction') }}" required autofocus></textarea>
                                    </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <label for="annual" class="col-md-4 control-label">ESTIMATED ANNUAL OFFTAKE</label>
                                    <div class="col-md-6">
                                        <input id="annual" type="text" class="form-control" name="annual" value="{{ old('annual') }}" required autofocus>
                                    </div>      
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <label for="payment" class="col-md-4 control-label">PAYMENT TERMS RECOMMENDED FOR CONSIDERATION</label>
                                    <div class="col-md-6">
                                        <textarea id="ckeditor4" type="text" class="form-control" name="payment" value="{{ old('payment') }}" required autofocus>
                                    </textarea></div>  
                        </div>
                        <hr>
                       ...
                       <div class="row">
                            <label for="justify" class="col-md-4 control-label">JUSTIFICATION, IF CREDIT IS RECOMMENDED</label>
                                    <div class="col-md-6">
                                        <textarea id="ckeditor5" type="text" class="form-control" name="justify" value="{{ old('justify') }}" required autofocus>
                                  </textarea>  </div>
                        </div>
                        <hr>
                         ...
                         <div class="row">
                            <label for="remarks" class="col-md-4 control-label">REMARKS, IF ANY</label>
                                    <div class="col-md-6">
                                        <textarea id="ckeditor6" type="text" class="form-control" name="remarks" value="{{ old('remarks') }}" required autofocus>
                                  </textarea>  </div>
                        </div>
                        <hr>
...
<script type="text/javascript">
    function dealing(nameSelect)
    {
        if(nameSelect)
        {
            Value = document.getElementById("yes").value;

            if(Value == nameSelect.value)
            {
                document.getElementById("dealingdiv").style.display = "block";
            }
            else
            {
                document.getElementById("dealingdiv").style.display = "none";
            }
        }
        else
        {
