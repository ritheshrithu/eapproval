...
<div class="container">
    <div class="col-md-12"><center>
            ...
            <a href="{{ url('/') }}/approvals/creditapproval">CREDIT APPROVAL    </a><span class="fa fa-arrow-right"></span></H4></center>
        </div>
</div><br>
                   ...
                   <div class="panel-body">   
                        <div class="table-responsive">
                            ...
                            @endif
                                        ...
                                        <td><center>
                                            <a href="{{ url('/') }}/approvals/creditapproval/{{$approval->id}}" class="btn btn-info">VIEW</a></center>
                                        </td>
                                    </tr>
