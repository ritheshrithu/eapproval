                        ...
                        <table width="100%" border="2px">
                            ...
                            <table width="100%">
                              <tbody>
                                    ...
                                    <tr>
                                    <td colspan="2">
                                      @if($credit->update1 !== null)
                                      <center>{{ $name }} &nbsp;<i class="fa fa-check" style="font-size:20px;color:green"></i></center>
                                        <center>{{ $credit->rec }} &nbsp;</center>
                                        <center>{{ \Carbon\Carbon::parse($credit->update1)->format('d/m/Y h:i A')}}</center><center>{{$credit->ip1}}</center>
                                      @else
                                        @if($credit->rec !== 0)
                                        <center>{{ $name }}</center>
                                        <center>{{ $credit->rec }}</center>@endif
                                    ...
                                    @else
                                      @if($credit->update2 !== null)
                                        <center>{{ $name1 }} &nbsp;<i class="fa fa-check" style="font-size:20px;color:green"></i></center>
                                        <center>{{ $credit->rec1 }} &nbsp;</center>
                                        <center>{{ \Carbon\Carbon::parse($credit->update2)->format('d/m/Y h:i A')}}</center><center>{{$credit->ip2}}</center>
                                      @else
                                        @if($credit->rec1 !== 0 && $credit->update2 === null)
                                    ...
                                    <td colspan="2">
                                      @if($rec2 === 0)
                                        <center>NOT APPLICABLE</center>
                                      @else
                                        @if($credit->update3 !== null)
                                          <center>{{ $name2 }} &nbsp;<i class="fa fa-check" style="font-size:20px;color:green"></i></center>
                                        <center>{{ $credit->rec2 }} &nbsp;</center>
                                          <center>{{ \Carbon\Carbon::parse($credit->update3)->format('d/m/Y h:i A')}}</center><center>{{$credit->ip3}}</center>
                                        @else
                                          @if($credit->rec2 !== 0)
                                            <center><i class="fa fa-refresh" style="font-size:30px;color:orange"></i></center>
                                          @endif
                                    ...
                                    <td colspan="2">
                                      @if($rec3 === 0)
                                        <center>NOT APPLICABLE</center>
                                      @else
                                        @if($credit->update4 !== null)
                                          <center>{{ $name3 }} &nbsp;<i class="fa fa-check" style="font-size:20px;color:green"></i></center>
                                        <center>{{ $credit->rec3 }} &nbsp;</center>
                                          <center>{{ \Carbon\Carbon::parse($credit->update4)->format('d/m/Y h:i A')}}</center><center>{{$credit->ip4}}</center>
                                        @else
                                          @if($credit->rec3 !== 0)
                                            <center><i class="fa fa-refresh" style="font-size:30px;color:orange"></i></center>
                                          @endif
