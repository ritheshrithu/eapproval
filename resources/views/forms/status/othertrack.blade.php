...
@section('content')
    ...
    <br>
        ...
        <div class="col-md-8">
            ...
            <a href="{{ url('/') }}/status/otherapproval"><u>OTHER APPROVAL  </u>  </a><span class="fa fa-arrow-right"></span></H4>
            </center>
        </div>
    </div>
</div>
                               ...
                               <tbody>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><center>REFERENCE ID</center></th>                                        <th><center>@sortablelink('TITLE')</center></th>
                                ...
                                @if(Auth::user()->roll === $approval->ref)
                                    <tr>
                                        ...
                                        <td><center>
                                            <a href="{{ url('/') }}/status/otherapproval/{{$approval->id}}" class="btn btn-info">VIEW</a></center>
                                        </td>
                                    </tr>
                            @endif
                            @endforeach
