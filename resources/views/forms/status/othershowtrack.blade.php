...
@section('content')
    <div class="container"><br>
        <div class="row">    
        <div class="col-md-2">
            <div class="row"> <a href="{{ url('/') }}/status/otherapproval" class="btn btn-info">GO BACK</a></div><br>
        </div>
        <div class="col-md-8">
            <center>
                <H4>
                  <a href="{{ url('/') }}/status/">STATUS    </a><span class="fa fa-arrow-right"></span>
            <a href="{{ url('/') }}/status/vendorapproval">OTHER APPROVAL    </a><span class="fa fa-arrow-right"></span>
            <a href="{{ url('/') }}/status/vendorapproval/{{ $approvals->id }}"><u>{{ $approvals->title }}</u>    </a>
          </H4>
            </center>
        </div>
    </div>
        ...
        <a href="{{url('/')}}/oldapprovals/otherapproval/{{ $approvals->id }}/final" class="btn btn-success" target="_blank">GENERATE PDF</a></center></div><br>
        @endif
    </div>
