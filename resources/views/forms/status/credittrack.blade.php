...
@section('content')
    ...
    <br>
        ...
        <div class="col-md-8">
            ...
            <a href="{{ url('/') }}/status/creditapproval"><u>CREDIT APPROVAL  </u>  </a><span class="fa fa-arrow-right"></span></H4>
            </center>
        </div>
    </div>
</div>
                               ...
                               <tbody>
                                ...
                                @if(Auth::user()->roll === $approval->ref)
                                    <tr>
                                        ...
                                        <td><center>
                                            <a href="{{ url('/') }}/status/creditapproval/{{$approval->id}}" class="btn btn-info">VIEW</a></center>
                                        </td>
                                    </tr>
                            @endif
                            @endforeach
