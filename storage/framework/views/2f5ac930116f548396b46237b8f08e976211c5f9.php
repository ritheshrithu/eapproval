<?php $__env->startSection('content'); ?>
    ...
    <br>
        ...
        <div class="col-md-8">
            ...
            <a href="<?php echo e(url('/')); ?>/status/creditapproval"><u>CREDIT APPROVAL  </u>  </a><span class="fa fa-arrow-right"></span></H4>
            </center>
        </div>
    </div>
</div>
                               ...
                               <tbody>
                                ...
                                <?php if(Auth::user()->roll === $approval->ref): ?>
                                    <tr>
                                        ...
                                        <td><center>
                                            <a href="<?php echo e(url('/')); ?>/status/creditapproval/<?php echo e($approval->id); ?>" class="btn btn-info">VIEW</a></center>
                                        </td>
                                    </tr>
                            <?php endif; ?>
