<?php $__env->startSection('content'); ?>
    ...
    <br>
        ...
        <div class="col-md-8">
            ...
            <a href="<?php echo e(url('/')); ?>/status/otherapproval"><u>OTHER APPROVAL  </u>  </a><span class="fa fa-arrow-right"></span></H4>
            </center>
        </div>
    </div>
</div>
                               ...
                               <tbody>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th><center>REFERENCE ID</center></th>                                        <th><center><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('TITLE'));?></center></th>
                                        <th><center><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('updated_at','DATE CREATED'));?></center></th>
                                        <th><center>ACTIONS</center></th>
                                    </tr>
                                </thead>
                                  <?php $i = ($approvals->currentPage()-1) * $approvals->perPage() + 1;?>
                                ...
                                <?php if(Auth::user()->roll === $approval->ref): ?>
                                    <tr>
                                        ...
                                        <td><center><?php echo e($approval->title); ?></center></td>
                                        <td><center><?php echo e(\Carbon\Carbon::parse($approval->created_at)->format('d/m/Y h:i A')); ?></center></td>
                                        <td><center>
                                            <a href="<?php echo e(url('/')); ?>/status/otherapproval/<?php echo e($approval->id); ?>" class="btn btn-info">VIEW</a></center>
                                        </td>
                                    </tr>
                            <?php endif; ?>
